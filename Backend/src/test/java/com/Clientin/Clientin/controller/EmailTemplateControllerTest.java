package com.Clientin.Clientin.controller;
    ...
    class EmailTemplateControllerTest {
        ...
        @Test
        @WithMockUser(authorities = "SCOPE_EMAILTEMPLATE_READ")
        ...
        @Test
        @WithMockUser(authorities = "SCOPE_EMAILTEMPLATE_WRITE")
        ...
        @Test
        @WithMockUser(authorities = "SCOPE_EMAILTEMPLATE_DELETE")
        ...
        @Test
        @WithMockUser(authorities = "SCOPE_EMAILTEMPLATE_UPDATE")
