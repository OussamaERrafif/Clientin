package com.Clientin.Clientin.controller;
    ...
    class NFCSessionControllerTest {

        @Autowired
        private MockMvc mockMvc;
        @MockBean
        private NFCSessionService nFCSessionService;
        @Autowired
        private ObjectMapper objectMapper;

        private final String TEST_ID = "TEST_ID_123";
        private final NFCSessionDTO validDto = createValidDto();
        ...
        void getAll_ShouldReturnPagedResources() throws Exception {
            ...
            mockMvc.perform(get(BASE_URL)
                    ...
                    .param("sort", "id,desc"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$._embedded.nFCSessionList[0].id").exists())
                .andExpect(jsonPath("$._links.self.href").exists());
        }
        ...
        private NFCSessionDTO createValidDto() {
            return NFCSessionDTO.builder()
                .id(TEST_ID)
